export function DarkModeButton({ onChange }: { onChange: () => void }) {
  return (
    <div onClick={onChange} className='cursor-pointer hover:scale-110 transition mr-4'>
      ...
      <svg className='hidden dark:block' width='24px' height='24px' viewBox='0 0 24 24' fill='none'>
        <path
