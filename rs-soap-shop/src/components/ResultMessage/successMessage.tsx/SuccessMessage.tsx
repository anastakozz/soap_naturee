  ...
  return (
    <>
      ...
      >
        ...
        <div className='z-20 bg-secondaryColor fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-normal px-sm py-big border-accentColor border-8 border-double'>
